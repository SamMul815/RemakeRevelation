...
public class Dragon_Landing_Decorator : DecoratorTask
{
    ...
    public override bool Run()
    {
        ...
        bool IsLanding = UtilityManager.DistanceCalc(DragonManager.Instance.transform.position, BlackBoard.Instance.FiexdPosition, LandingDistance) && BlackBoard.Instance.IsFiexdPosition;
