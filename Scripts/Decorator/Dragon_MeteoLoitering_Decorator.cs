...
public class Dragon_MeteoLoitering_Decorator : DecoratorTask
{
    bool isMeteoLoitering;

    public override void Init()
    {
        base.Init();
        isMeteoLoitering = false;
    }
    ...
    {
        isMeteoLoitering = _blackBoard.IsMeteoLoitering;

        if ((isMeteoLoitering && !_manager.IsAction) || _manager.IsAction)
        {
            if (_childAction)
            {
