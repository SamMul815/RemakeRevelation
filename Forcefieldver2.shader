...
////// Emissive:
                ...
                float2 node_2869 = ((float2(_Utexspeed,_Vtexspeed)*node_7025.g)+(((node_5822*node_5822)+i.uv0)+node_5464.g*float2(0,0)));
